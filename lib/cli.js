...
var optionator,
    optionDefinitions = [
        ...
        },
        {
            ...
            alias: "W",
            type: "[String]",
            description: "A comma-separated list of optional warnings to specify, enable or disable. To enable/disable all optional warnings, use \"all\"/\"none\". To enable a specific optional warning, prefix it with \"+\". To disable a specific optional warning, prefix it with \"no-\". To specify the list of enabled optional warnings, use names without prefixes. A list of optional warnings may not be mixed with \"+\" or \"no-\" prefixed warnings. Use --list-optional-warnings to see the list of optional warning names. Note that there are many non-optional compiler warnings that will not be affected by this option."
        },
        {
            option: "colorize",
            type: "Boolean",
