...
{
    return ["compact", "locations", "ecma"].indexOf(option.option) < 0;
}
...
const
    optionDefinitions = [
        ...
        {
            option: "generate-type-signatures",
            alias: "t",
            type: "Boolean",
            default: "true",
...
function parseOptions(args, parseOpts)
{
    ...
    if (options.maxErrors < 1)
        acornObjj.utils.failWithMessage("--max-errors must be >= 1");
