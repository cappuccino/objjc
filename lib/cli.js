...
var optionator,
    optionDefinitions = [
        ...
        },
        {
            ...
            type: "Boolean",
            default: "false",
            description: "Prevents the parser from doing automatic semicolon insertion (the default). " +
        ...
        },
        {
            ...
            type: "Boolean",
            default: "false",
            description: "Comments in the source are included in the compiled code. " +
                "May only be used in conjunction with --format."
        },
        {
            option: "include-comment-line-breaks",
            type: "Boolean",
            default: "false",
            description: "Line breaks before comments are included in the compiled code. " +
                "May only be used in conjunction with --include-comments."
        },
        {
            option: "quiet",
            alias: "q",
        ...
        },
        {
            ...
            description: "If set, the global DEBUG variable is set to true. " +
                "This allows you to wrap debugging statements in `if (DEBUG)`, which will be removed by uglify."
        },
        {
            option: "stack-trace",
            type: "Boolean",
