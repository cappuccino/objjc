...
var compile = function(node, scope, visitor)  // jshint ignore:line
{
    ...
    if (scope.currentMethodType() === "-" && !scope.secondMemberExpression && !scope.isPropertyKey)
    {
        ...
        if (ivar)
        {
            ...
            else
            {
                ...
                scope.addedSelfToIvars[identifier].push({ node: node, index: compiler.jsBuffer.length });  // jshint ignore:line
