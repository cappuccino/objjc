...
(function(mod)
{
    ...
    if (typeof exports === "object" && typeof module === "object")
        return mod(exports, require("objj-acorn/acorn"), require("objj-acorn/util/walk"), require("source-map"));

    // AMD
    if (typeof define === "function" && define.amd)
        return define(["exports", "objj-acorn/acorn", "objj-acorn/util/walk", "source-map"], mod);
...
var ObjjGenerateFileDependencies = 1,
    ObjjGenerateCode = 2;
...
var Compiler = function(/*String*/ source, /*String*/ aURL, options)
{
    this.source = source;
    ...
    if (this.generateWhat === ObjjGenerateCode)
    {
...
exports.compileToExecutable = function(/*String*/ source, /*CFURL*/ aURL, options)
{
    Compiler.currentCompileFile = aURL;
    return new Compiler(source, aURL, options).executable();
};

exports.compileToIMBuffer = function(/*String*/ source, /*CFURL*/ aURL, options)
{
    return new Compiler(source, aURL, options).IMBuffer();
};

exports.compile = function(/*String*/ source, /*CFURL*/ aURL, options)
{
    return new Compiler(source, aURL, options);
};

exports.compileFileDependencies = function(/*String*/ source, /*CFURL*/ aURL, options)
{
    Compiler.currentCompileFile = aURL;
    (options || (options = {})).generateWhat = ObjjGenerateFileDependencies;
    return new Compiler(source, aURL, options).executable();
};
...
Compiler.prototype.compilePass2 = function()
{
    ...
    this.generateWhat = ObjjGenerateCode;
...
*/
    ...
    if (!generateObjJ && !isInterfaceDeclaration && hasAccessors)
    {
        ...
        var b = getterSetterBuffer.toString().replace(/@accessors(\(.*\))?/g, ""),
            imBuffer = exports.compileToIMBuffer(b, "Accessors", this.options);
