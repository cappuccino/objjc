...
function makeSelector(compiler, state, compileNode, nodeArguments, types, selectors, selector, generateObjJ)  // -> selector
{
...
// Helper for codeGenerator.MethodDeclarationStatement
function compileMethodBody(compiler, node, state, compileNode, nodeArguments, methodScope, selector, generate, generateObjJ)
{
    if (node.body)
    {
        if (!generateObjJ)
