...
StringBuffer.prototype.concatFormattedString = function(node, scope, before, string, after)
{
...
var Compiler = function(/* String */ source, /* String | CFURL */ url, options)
{
    ...
    compileWithFormat(this.AST, new Scope(null, { compiler: this }), generator);
...
MemberExpression: function(node, scope, compileNode)
{
    ...
    parenthesizeExpression(!computed, node, node.property, scope, compileNode);
