...
new objj_method(sel_getUid("${selector}"),`;
        ...
        if (objj.body)
        {
            ...
            methodScope.vars.self = { type: "implicit method argument", scope: methodScope };
            methodScope.vars._cmd = { type: "implicit method argument", scope: methodScope };
            ...
            for (const arg of args)
            {
                ...
                methodScope.vars[argName] = { type: "method argument", node: arg.id };
            }
