...
{
    String.prototype.repeat = function(/* int */ count)
    {
        "use strict";
...
Scope.prototype.format = function(index, format, useOverrideForNode)
{
    ...
    // Let's check if we have any other descriptions dependent on the prior node.
            ...
            if (line.slice(0, 1) === "\\")
            {
                ...
                if (indentationNumber)
                {
                    this.concat(indentationNumber > 0 ?
                                indentation + indentString.repeat(indentationNumber * indentWidth) :
...
exports.compileToIMBuffer = function(/* String */ source, /* CFURL | String */ url, classDefs, protocolDefs)
{
...
var compileWithFormat = function(node, scope, visitor)
{
    ...
    var compileNode = function(node, scope, override)
    {
        ...
        visitor[override || node.type](node, scope, compileNode, format);
...
{
    return function(node, scope, override, format)
    {
        scope.compiler.jsBuffer.concat("(");
        compileNode(node, scope, override, format);
        scope.compiler.jsBuffer.concat(")");
    };
};
...
var declareClass = function(compiler, node, classDef, className, isInterfaceDeclaration, generateObjJ, saveJSBuffer)  // -> classDef
{
    if (node.superclassname)
    {
        ...
        if (!superClassDef)
        {
            ...
            for (var i = Compiler.importStack.length; i >= 0; i--)
                errorMessage += "\n" + " ".repeat((Compiler.importStack.length - i) * 2) + "Imported by: " + Compiler.importStack[i];
...
// Helper for codeGenerator.ClassDeclarationStatement
var addIvars = function(compiler, node, compileNode, scope, classDef, className, classScope, firstIvarDeclaration, generateObjJ, saveJSBuffer)  // -> hasAccessors
{
...
// Helper for codeGenerator.ClassDeclarationStatement
var generateGetterSetter = function(compiler, node)
{
...
BlockStatement: function(node, scope, compileNode, format)
{
    var compiler = scope.compiler,
...
ExpressionStatement: function(node, scope, compileNode, format)
{
    var compiler = scope.compiler,
...
IfStatement: function(node, scope, compileNode, format)
{
    var compiler = scope.compiler,
        buffer;
...
LabeledStatement: function(node, scope, compileNode, format)
{
    var compiler = scope.compiler;
...
BreakStatement: function(node, scope, compileNode, format)
{
    var compiler = scope.compiler;
...
ContinueStatement: function(node, scope, compileNode, format)
{
    var compiler = scope.compiler;
...
WithStatement: function(node, scope, compileNode, format)
{
    var compiler = scope.compiler,
        buffer;
...
SwitchStatement: function(node, scope, compileNode, format)
{
    var compiler = scope.compiler,
...
ReturnStatement: function(node, scope, compileNode, format)
{
    var compiler = scope.compiler,
        generate = compiler.generate,
        buffer;
...
ThrowStatement: function(node, scope, compileNode, format)
{
    var compiler = scope.compiler,
        generate = compiler.generate,
        buffer;
...
TryStatement: function(node, scope, compileNode, format)
{
    var compiler = scope.compiler,
        generate = compiler.generate,
        buffer;
...
WhileStatement: function(node, scope, compileNode, format)
{
    var compiler = scope.compiler,
        generate = compiler.generate,
        body = node.body,
...
DoWhileStatement: function(node, scope, compileNode, format)
{
    var compiler = scope.compiler,
        generate = compiler.generate,
        buffer;
...
ForStatement: function(node, scope, compileNode, format)
{
    var compiler = scope.compiler,
        generate = compiler.generate,
        body = node.body,
...
ForInStatement: function(node, scope, compileNode, format)
{
    var compiler = scope.compiler,
        generate = compiler.generate,
        body = node.body,
...
DebuggerStatement: function(node, scope, compileNode, format)
{
    var compiler = scope.compiler;
...
Function: function(node, scope, compileNode, format)
{
    var compiler = scope.compiler,
        generate = compiler.generate,
        buffer = compiler.jsBuffer,
...
VariableDeclaration: function(node, scope, compileNode, format)
{
    var compiler = scope.compiler,
        generate = compiler.generate,
        buffer,
...
ArrayExpression: function(node, scope, compileNode, format)
{
    var compiler = scope.compiler,
        generate = compiler.generate,
        buffer;
...
ObjectExpression: function(node, scope, compileNode, format)
{
    var compiler = scope.compiler,
        generate = compiler.generate,
...
SequenceExpression: function(node, scope, compileNode, format)
{
    var compiler = scope.compiler,
        generate = compiler.generate,
        buffer;
...
BinaryExpression: function(node, scope, compileNode, format)
{
    var compiler = scope.compiler,
        generate = compiler.generate;
...
LogicalExpression: function(node, scope, compileNode, format)
{
    var compiler = scope.compiler,
        generate = compiler.generate;
...
AssignmentExpression: function(node, scope, compileNode, format)
{
    var compiler = scope.compiler,
        generate = compiler.generate,
        buffer = compiler.jsBuffer;
...
ConditionalExpression: function(node, scope, compileNode, format)
{
    var compiler = scope.compiler,
        generate = compiler.generate,
        buffer;
...
NewExpression: function(node, scope, compileNode, format)
{
    var compiler = scope.compiler,
...
CallExpression: function(node, scope, compileNode, format)
{
    var compiler = scope.compiler,
        nodeArguments = node.arguments,
        generate = compiler.generate,
...
ClassDeclarationStatement: function(node, scope, compileNode)
{
    ...
    if (node.ivardeclarations)
        hasAccessors = addIvars(compiler, node, compileNode, scope, classDef, className, classScope, firstIvarDeclaration, generateObjJ, saveJSBuffer);
