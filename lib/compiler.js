...
function setupWarnings(/* Array */ warnings)
{
    ...
    Object.merge(result, defaultOptions.warnings);
    ...
    warnings.every(function(warning)
    {
        ...
        if (defaultOptions.warnings.hasOwnProperty(warning))
            result[warning] = value;
        else
            console.warn("objjc: unknown compiler warning '%s'", warning);
...
Compiler.prototype.identifierIsGlobal = function(identifier)
{
    return identifier in this.globals;
};

Compiler.prototype.predefinedGlobal = function(identifier)
{
...
Compiler.prototype.filterIdentifierIssues = function(scope)
{
    ...
    {
        if (issue instanceof exceptions.GlobalIdentifierIssue)
            return !issue.identifierIsValid(scope);
