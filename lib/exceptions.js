...
exports.setColorMap = function(map)
{
    for (var key in map)
    {
        if (map.hasOwnProperty(key) && colorMap.hasOwnProperty(key))
...
var GlobalIdentifierIssue = function(source, file, node, message)
{
    this.init(source, file, node, message);
};

initClass(GlobalIdentifierIssue, CompilerIssue);
exports.GlobalIdentifierIssue = GlobalIdentifierIssue;
...
initClass(ImplicitGlobalWarning, GlobalIdentifierIssue);
exports.ImplicitGlobalWarning = ImplicitGlobalWarning;

ImplicitGlobalWarning.prototype.identifierIsValid = function(scope)
{
    var identifier = this.node.name;

    return scope.getVar(identifier) || global.hasOwnProperty(identifier);
};
...
initClass(UnknownIdentifierWarning, GlobalIdentifierIssue);
exports.UnknownIdentifierWarning = UnknownIdentifierWarning;

UnknownIdentifierWarning.prototype.identifierIsValid = function(scope)
{
    var identifier = this.node.name;

    return (
        scope.getVar(identifier) ||
        global.hasOwnProperty(identifier) ||
...
initClass(GlobalIdentifierNote, GlobalIdentifierIssue);
