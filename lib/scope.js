...
class Scope
{
    ...
    static parentNodeType(node, index)
    {
        ...
        return parentNode ? parentNode.type : null;
    }
    ...
    getVar(name, type)
    {
        ...
        do
        {
            ...
            // If we are looking for a local var scope, the current scope
            // is the one we are looking for, and we didn't find the name, we're done.
