...
[    
    ...
    {
        console.log(CPString.isa.objj_msgSend(CPString, "stringWithFormat:", "%s, %d, %s, %i", something, number, and, also));
    },
    // argument types
    ...
    {
        self.isa.objj_msgSend(self, "doSomething:withNumber:and:andAlso:", "bold", 7, "something else", 27);
        objj_msgSendSuper({ receiver: self, super_class: objj_getClass("Test").super_class }, "manyArgs:two:three:four:", 1, 2, 3, 4);
    },
    // argument types
    ["void"]),
]);
