...
// cannot find implementation declaration for 'Superclass', superclass of 'Subclass'
@implementation Subclass : Superclass
@end

// cannot find implementation declaration for 'Unknown'
@implementation Unknown (Category)
@end

@implementation Bar (Category)
@end

// duplicate definition of category 'Bar (Category)'
@implementation Bar (Category)
@end
